	...
	<div class="container">
		...
		<div class="col-sm-3 col-sm-offset-1 blog-sidebar">
			...
			<div class="sidebar-module sidebar-module-inset">
				...
				<h4>Statystyki:</h4>
				<p>
					<strong>Wyslane wiadomosci: </strong><em>${sendM}</em><br> <strong>Odebrane
						wiadomosci: </strong><em>${recievedM}</em><br> <strong>Rejestracia:
					</strong><em>${registraionDate}</em><br> <strong>Ostatnio
						online: </strong><em>${lastOnline}</em><br> <strong>Ilość
						kontaktów: </strong><em>${contactAmound}</em><br> <strong>ID:
					</strong><em>${id}</em><br>

				</p>
				<form method="post" action="addcontact">
					<input type="submit" value="Dodaj do kontaktow"/>
